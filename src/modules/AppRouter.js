...
import PushNotificationsViewContainer from '../modules/settings/push-notifications/PushNotificationsViewContainer';
          ...
          <Scene key='tabbar' >
            ...
            >
              ...
              <Scene key='profile' title='Profile' icon={TabIcon} display='emoji-happy'>
                ...
                <Scene key='pushNotifications' component={PushNotificationsViewContainer} title="Push Notifications" hideNavBar={true} hideTabBar={true}/>
              </Scene>
