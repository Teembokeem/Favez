        ...
        <View style={styles.ListHeader}>
            <View style={styles.leftContent}>
                ...
                <Image source={picture
                    ...
                    : require('../../../../images/default_avatar.png')} style={styles.ListHeaderAvatar}/>
                <Text style={styles.ListHeaderUsername}>
                    {'@' + nickname
}
                    {collaborators > 0
                        ? ' & ' + collaborators + ' other' + semantics + '.'
                        : ''}
                </Text>
            </View>
            <TouchableOpacity style={styles.rightContent} onPress={() => toggleContextMenu('list')}>
